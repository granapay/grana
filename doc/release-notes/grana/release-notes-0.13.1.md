...
See detailed [set of changes](https://github.com/granapay/grana/compare/v0.13.0.0...granapay:v0.13.1.0).

### Backports

- [`da5a861c0`](https://github.com/granapay/grana/commit/da5a861c0) Change the way invalid ProTxes are handled in `addUnchecked` and `existsProviderTxConflict` (#2691)
- [`6ada90c11`](https://github.com/granapay/grana/commit/6ada90c11) Call existsProviderTxConflict after CheckSpecialTx (#2690)
- [`23eb70cb7`](https://github.com/granapay/grana/commit/23eb70cb7) Add getspecialtxes rpc (#2668)
- [`023f8a01a`](https://github.com/granapay/grana/commit/023f8a01a) Fix bench log for payee and special txes (#2678)
- [`8961a6acc`](https://github.com/granapay/grana/commit/8961a6acc) Stop checking MN protocol version before signalling DIP3 (#2684)
- [`e18916386`](https://github.com/granapay/grana/commit/e18916386) Add missing help text for `operatorPayoutAddress` (#2679)
- [`0d8cc0761`](https://github.com/granapay/grana/commit/0d8cc0761) Invoke CheckSpecialTx after all normal TX checks have passed (#2673)
- [`592210daf`](https://github.com/granapay/grana/commit/592210daf) Bump block stats when adding commitment tx into block (#2654)
- [`070ad103f`](https://github.com/granapay/grana/commit/070ad103f) Wait for script checks to finish before messing with txes in Grana-specific way (#2652)
- [`3a3586d5a`](https://github.com/granapay/grana/commit/3a3586d5a) Use helper function to produce help text for params of `protx` rpcs (#2649)
- [`332e0361c`](https://github.com/granapay/grana/commit/332e0361c) Add checkbox to show only masternodes the wallet has keys for (#2627)

### Other

- [`bd0de4876`](https://github.com/granapay/grana/commit/bd0de4876) Bump version to 0.13.1 (#2686)
