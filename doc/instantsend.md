...
This mechanism has been integrated into Bitcore-Node-Grana which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/granapay/insight-api-grana#web-socket-api](https://github.com/granapay/insight-api-grana#web-socket-api)
* API: [https://github.com/granapay/insight-api-grana#instantsend-transactions](https://github.com/granapay/insight-api-grana#instantsend-transactions)
