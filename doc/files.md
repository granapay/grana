...
* grana.conf: contains configuration settings for granad or grana-qt
* granad.pid: stores the process id of granad while running
...
* debug.log: contains debug information and general logging generated by granad or grana-qt
