...
This document provides guidelines for internationalization of the Grana Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `grana_en.ts` remains unchanged.
