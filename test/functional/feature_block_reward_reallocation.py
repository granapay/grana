#!/usr/bin/env python3
# Copyright (c) 2015-2020 The Grana Core developers
...
class BlockRewardReallocationTest(GranaTestFramework):
    def set_test_params(self):
        self.set_grana_test_params(2, 1, fast_dip3_enforcement=True)
        self.set_grana_dip8_activation(450)
