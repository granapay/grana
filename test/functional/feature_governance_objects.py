#!/usr/bin/env python3
# Copyright (c) 2018-2020 The Grana Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Tests around grana governance objects."""
...
class GranaGovernanceTest (GranaTestFramework):
    def set_test_params(self):
        self.set_grana_test_params(2, 1)
