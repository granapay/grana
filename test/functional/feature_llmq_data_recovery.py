...
class QuorumDataRecoveryTest(GranaTestFramework):
    def set_test_params(self):
        extra_args = [["-vbparams=dip0020:0:999999999999:10:8:6:5"] for _ in range(9)]
        self.set_grana_test_params(9, 7, fast_dip3_enforcement=True, extra_args=extra_args)
        self.set_grana_llmq_test_params(4, 3)
