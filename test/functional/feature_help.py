...
"""Verify that starting granad with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start granad with -h for help text")
        ...
        self.log.info("Start granad with -version for version information")
