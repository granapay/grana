#!/usr/bin/env python3
# Copyright (c) 2020-2021 The Grana Core developers
...
class RPCVerifyISLockTest(GranaTestFramework):
    def set_test_params(self):
        # -whitelist is needed to avoid the trickling logic on node0
        self.set_grana_test_params(6, 5, [["-whitelist=127.0.0.1"], [], [], [], [], []], fast_dip3_enforcement=True)
