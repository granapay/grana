#!/usr/bin/env python3
# Copyright (c) 2015-2021 The Grana Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
from test_framework.mininode import *
from test_framework.test_framework import GranaTestFramework
...
class LLMQCoinbaseCommitmentsTest(GranaTestFramework):
    def set_test_params(self):
        self.set_grana_test_params(4, 3, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as GranaTestFramework doesn't support this atm)
