...
"""Test the grana specific ZMQ notification interfaces."""
...
from test_framework.test_framework import (
     GranaTestFramework, skip_if_no_bitcoind_zmq, skip_if_no_py3_zmq)
...
class GranaZMQTest (GranaTestFramework):
    def set_test_params(self):
        ...
        self.set_grana_test_params(4, 3, fast_dip3_enforcement=True, extra_args=[node0_extra_args, [], [], []])

    def run_test(self):
        # Check that granad has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all grana related ZMQ publisher
