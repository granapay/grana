Contributing to Grana Core
============================

The Grana Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/granapay/grana/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Grana Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Grana
Network Protocol consensus changes.

Whether a pull request is merged into Grana Core rests with the project merge
...
Patches that change Grana consensus rules are considerably more involved than
...
Where a patch set proposes to change the Grana consensus, it must have been
...
The review process is normally fairly responsive on the Grana Core repository, however
...
The project leader is the release manager for each Grana Core release.
