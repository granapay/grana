...
All the Grana in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 GRANA, 0.01 GRANA, 0.1 GRANA, 1 GRANA and 10 GRANA -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a style=\"%2\" href=\"%3\">%1 documentation</a>."
        ...
        .arg("https://docs.grana.org/en/stable/wallets/granacore/coinjoin-instantsend.html")
        );
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
