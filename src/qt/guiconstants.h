...
/* GranaGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* GranaGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Grana"
#define QAPP_ORG_DOMAIN "grana.org"
#define QAPP_APP_NAME_DEFAULT "Grana-Qt"
#define QAPP_APP_NAME_TESTNET "Grana-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Grana-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Grana-Qt-regtest"
