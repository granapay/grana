...
//
//     src/qt/test/test_grana-qt -platform xcb      # Linux
//     src/qt/test/test_grana-qt -platform windows  # Windows
//     src/qt/test/test_grana-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(2).indexOf(QString("URI: grana:")) != -1);
