...
/** Utility functions used by the Grana Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "grana:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load grana specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a grana specific theme is activated (light/dark).*/
