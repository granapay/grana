...
<context>
    ...
    <message>
        ...
        <translation>Это ваши адреса Grana для отправки платежей. Всегда проверяйте количество и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши адреса Grana для приёма платежей. Рекомендуется использовать новый адрес получения для каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: если Вы зашифруете кошелёк и потеряете пароль, вы &lt;b&gt;ПОТЕРЯЕТЕ ВСЕ ВАШИ GRANA&lt;/b&gt;!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Произошла критическая ошибка. Дальнейшая безопасная работа Grana Core невозможна, программа будет закрыта.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отправить монеты на указанный адрес Grana</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Запросить платежи (создать QR-коды и grana: URI)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать информацию о Grana Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отправить %1 средства на Grana адрес</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщения вашими адресами Grana, чтобы доказать, что вы ими владеете</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Проверить сообщения, чтобы удостовериться, что они были подписаны определёнными адресами Grana</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть grana: URI или запрос платежа</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активное соединение с сетью Grana</numerusform><numerusform>%n активных соединения с сетью Grana</numerusform><numerusform>%n активных соединений с сетью Grana</numerusform><numerusform>%n активных соединений с сетью Grana</numerusform></translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введённый адрес "%1" не является правильным адресом Grana.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>%1 скачает и сохранит копию цепочки блоков Grana.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Последние транзакции пока что могут быть не видны и поэтому ваш баланс может отображаться некорректно. Информация будет корректироваться по мере синхронизации с сетью Grana, подробности о ходе синхронизации представлены ниже.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для Grana Core на роутере. Работает только в том случае, если Ваш роутер поддерживает UPnP и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети Grana через прокси SOCKS5.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети Grana через отдельный прокси SOCKS5 для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш кошелёк автоматически синхронизируется с сетью Grana после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>0 GRANA / 0 раундов</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить обработчик grana: click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>'grana://' не является валидным URI. Используйте 'grana:'.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось разобрать URI! Возможно указан некорректный адрес Grana либо параметры URI сформированы неверно.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес Grana (например, %1)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть Grana.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса.&lt;br&gt;Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть Grana.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: неверный адрес Grana</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Grana для отправки на него монет</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссия будет вычтена из отправляемой суммы. Получателю придет меньше Grana, сем указано в поле "Сумма". Если указано несколько получателей, то комиссия будет разделена между ними поровну.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>К grana: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Обратите внимание: сообщение не будет отправлено через сеть Grana.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Вы можете подписывать сообщения своими адресами, чтобы доказать, что Вы можете получать Grana на них. Будьте осторожны, не подписывайте что-то неопределённое, так как фишинговые атаки могут обманным путём заставить вас подписать нежелательные сообщения. Подписывайте только те сообщения, с которыми вы согласны вплоть до мелочей.</translation>
    </message>
    <message>
        <source>The Grana address to sign the message with</source>
        <translation>Адрес Grana, которым Вы хотите подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выбрать ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение этим адресом Grana</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;сообщение</translation>
    ...
    <message>
        ...
        <translation>Адрес Grana, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified Grana address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным адресом Grana</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;сообщение</translation>
