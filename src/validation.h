...
//! Discourage users to set fees higher than this amount (in pilas) per kB
static const CAmount HIGH_TX_FEE_PER_KB = 0.01 * COIN;
//! -maxtxfee will warn if called with a higher fee than this amount (in pilas)
...
/** Absolute maximum transaction fee (in pilas) used by wallet and mempool (rejects high fee in sendrawtransaction) */
