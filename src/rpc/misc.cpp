...
UniValue debug(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            " - \"grana\" activates all Grana-specific categories at once;\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("debug", "grana")
            + HelpExampleRpc("debug", "grana+net")
        );
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nReturn information about the given grana address.\n"
            ...
            "\nArguments:\n"
            "1. \"address\"                    (string, required) The grana address to validate\n"
            "\nResult:\n"
            "{\n"
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The grana address to use for the signature.\n"
...
UniValue getaddressmempool(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "    \"satoshis\"  (number) The difference of pilas\n"
...
UniValue getaddressutxos(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "    \"satoshis\"  (number) The number of pilas of the output\n"
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"balance\": xxxxx,              (numeric) The current total balance in pilas\n"
            "  \"balance_immature\": xxxxx,     (numeric) The current immature balance in pilas\n"
            "  \"balance_spendable\": xxxxx,    (numeric) The current spendable balance in pilas\n"
            "  \"received\": xxxxx              (numeric) The total number of pilas received (including change)\n"
            "}\n"
            "\nExamples:\n"
...
UniValue echo(const JSONRPCRequest& request)
{
    if (request.fHelp)
        throw std::runtime_error(
            ...
            "grana-cli and the GUI. There is no server-side difference."
        );
...
static UniValue getinfo_deprecated(const JSONRPCRequest& request)
{
    throw JSONRPCError(RPC_METHOD_NOT_FOUND,
        ...
        "\ngrana-cli has the option -getinfo to collect and format these in the old format."
    );
}
