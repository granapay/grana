...
/*
    ...
    allow endless transaction that would bloat Grana and make it unusable. To
...
bool CCoinJoinServer::IsInputScriptSigValid(const CTxIn& txin)
{
    ...
    if (nTxInIndex >= 0) { //might have to do this one input at a time?
        ...
        // TODO we're using amount=0 here but we should use the correct amount. This works because Grana ignores the amount while signing/verifying (only used in Bitcoin/Segwit)
