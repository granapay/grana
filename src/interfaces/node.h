...
//! Interface for the src/evo part of a grana node (granad process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a grana node (granad process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a grana node (granad process).
...
//! Top-level interface for a grana node (granad process).
class Node
{
public:
    virtual ~Node() {}
