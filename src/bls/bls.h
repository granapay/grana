...
#ifndef GRANA_CRYPTO_BLS_H
#define GRANA_CRYPTO_BLS_H
...
// bls-grana uses relic, which may define DEBUG and ERROR, which leads to many warnings in some build setups
#undef ERROR
#undef DEBUG
#include <bls-grana/bls.hpp>
#include <bls-grana/privatekey.hpp>
#include <bls-grana/elements.hpp>
#include <bls-grana/schemes.hpp>
#include <bls-grana/threshold.hpp>
#undef DOUBLE
